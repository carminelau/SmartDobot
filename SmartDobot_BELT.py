...
def avvia_rullo(device):
    # per modificare la direzione e la velocità della belt
    # device.conveyor_belt(speed, direction=1 (1 // -1), interface=0)
...
def trova_contorni(frame, lista_contorni):  
    ...
    _, threshold = cv2.threshold(gray_belt, 25, 255, cv2.THRESH_BINARY)
